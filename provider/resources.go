...
import (
	...
	"github.com/freitt/pulumi-yandex/provider/pkg/version"
)
...
// 	return tfbridge.MakeDataSource("yandex", mod, "get"+name)
// }

// func makeResource(mod string, res string) tokens.Type {
// 	return tfbridge.MakeResource("yandex", mod, convertName(res))
// }
...
// Instantiate the Terraform provider
	...
	prov := tfbridge.ProviderInfo{
		...
		LogoURL: "https://raw.githubusercontent.com/freitt/pulumi-yandex/main/docs/yandex.png",
		// PluginDownloadURL is an optional URL used to download the Provider
		// for use in Pulumi programs
		// e.g https://github.com/org/pulumi-provider-name/releases/
		PluginDownloadURL: "github://api.github.com/freitt/pulumi-yandex",
		Description:       "A Pulumi package for creating and managing Yandex resources",
		...
		License:    "Apache-2.0",
		Homepage:   "https://github.com/freitt/pulumi-yandex",
		Repository: "https://github.com/freitt/pulumi-yandex",
		...
		Resources:            map[string]*tfbridge.ResourceInfo{
			...
			// 		"tags": {Type: tfbridge.MakeType("yandex", "Tags")},
			// 	},
			// },
			...
			"yandex_billing_cloud_binding":                        {Tok: makeResource(mainMod, "billingCloudBinding")},
			...
			"yandex_kms_asymmetric_encryption_key_iam_binding":                        {Tok: makeResource(mainMod, "kmsAsymmetricEncryptionKeyIamBinding")},
			"yandex_kms_asymmetric_signature_key":                        {Tok: makeResource(mainMod, "kmsAsymmetricSignatureKey")},
			"yandex_kms_asymmetric_signature_key_iam_binding":                        {Tok: makeResource(mainMod, "kmsAsymmetricSignatureKeyIamBinding")},
			"yandex_lockbox_secret_iam_binding":                        {Tok: makeResource(mainMod, "lockboxSecretIamBinding")},
			...
			"yandex_ydb_topic":                        {Tok: makeResource(mainMod, "ydbTableTopic")},
		},
		DataSources: map[string]*tfbridge.DataSourceInfo{
			...
			"yandex_compute_gpu_cluster": {
				Tok: makeDataSource(mainMod, "getComputeGpuCluster"),
				Docs: &tfbridge.DocInfo{
					Source: "datasource_yandex_compute_gpu_cluster.html.markdown",
				},
			},
			"yandex_compute_snapshot_schedule": {
				Tok: makeDataSource(mainMod, "getComputeSnapshotSchedule"),
				Docs: &tfbridge.DocInfo{
					Source: "datasource_yandex_compute_snapshot_schedule.html.markdown",
				},
			},
			...
			"yandex_container_repository_lifecycle_policy": {
				...
				Docs: &tfbridge.DocInfo{
					Source: "datasource_yandex_container_repository_lifecycle_policy.html.markdown",
				},
			},
			"yandex_iot_core_broker": {
				Tok: makeDataSource(mainMod, "getIotCoreBroker"),
				Docs: &tfbridge.DocInfo{
					Source: "datasource_yandex_iot_core_broker.html.markdown",
				},
			},
			"yandex_kms_asymmetric_encryption_key": {
				Tok: makeDataSource(mainMod, "getKmsAsymmetricEncryptionKey"),
				Docs: &tfbridge.DocInfo{
					Source: "datasource_yandex_kms_asymmetric_encryption_key.html.markdown",
				},
			},
			"yandex_kms_asymmetric_signature_key": {
				Tok: makeDataSource(mainMod, "getKmsAsymmetricSignatureKey"),
				Docs: &tfbridge.DocInfo{
					Source: "datasource_yandex_kms_asymmetric_signature_key.html.markdown",
				},
			},
			"yandex_kms_symmetric_key": {
				Tok: makeDataSource(mainMod, "getKmsSymmetricKey"),
				Docs: &tfbridge.DocInfo{
					Source: "datasource_yandex_kms_symmetric_key.html.markdown",
				},
			},
			"yandex_lockbox_secret": {
				Tok: makeDataSource(mainMod, "getLockboxSecret"),
				Docs: &tfbridge.DocInfo{
					Source: "datasource_yandex_lockbox_secret.html.markdown",
				},
			},
			"yandex_lockbox_secret_version": {
				Tok: makeDataSource(mainMod, "getLockboxSecretVersion"),
				Docs: &tfbridge.DocInfo{
					Source: "datasource_yandex_lockbox_secret_version.html.markdown",
				},
			},
			"yandex_mdb_kafka_connector": {
				Tok: makeDataSource(mainMod, "getMdbKafkaConnector"),
				Docs: &tfbridge.DocInfo{
					Source: "datasource_yandex_mdb_kafka_connector.html.markdown",
				},
			},
			"yandex_mdb_kafka_user": {
				Tok: makeDataSource(mainMod, "getMdbKafkaUser"),
				Docs: &tfbridge.DocInfo{
					Source: "datasource_yandex_mdb_kafka_user.html.markdown",
				},
			},
			"yandex_mdb_mysql_database": {
				Tok: makeDataSource(mainMod, "getMdbMysqlDatabase"),
				Docs: &tfbridge.DocInfo{
					Source: "datasource_yandex_mdb_mysql_database.html.markdown",
				},
			},
			"yandex_mdb_mysql_user": {
				Tok: makeDataSource(mainMod, "getMdbMysqlUser"),
				Docs: &tfbridge.DocInfo{
					Source: "datasource_yandex_mdb_mysql_user.html.markdown",
				},
			},
			"yandex_mdb_postgresql_database": {
				Tok: makeDataSource(mainMod, "getMdbPostgresqlDatabase"),
				Docs: &tfbridge.DocInfo{
					Source: "datasource_yandex_mdb_postgresql_database.html.markdown",
				},
			},
			"yandex_mdb_postgresql_user": {
				Tok: makeDataSource(mainMod, "getMdbPostgresqlUser"),
				Docs: &tfbridge.DocInfo{
					Source: "datasource_yandex_mdb_postgresql_user.html.markdown",
				},
			},
			"yandex_monitoring_dashboard": {
				Tok: makeDataSource(mainMod, "getMonitoringDashboard"),
				Docs: &tfbridge.DocInfo{
					Source: "datasource_yandex_monitoring_dashboard.html.markdown",
				},
			},
			"yandex_organizationmanager_group": {
				Tok: makeDataSource(mainMod, "getOrganizationmanagerGroup"),
				Docs: &tfbridge.DocInfo{
					Source: "datasource_yandex_organizationmanager_group.html.markdown",
				},
			},
			"yandex_vpc_gateway": {
				Tok: makeDataSource(mainMod, "getVpcGateway"),
				Docs: &tfbridge.DocInfo{
					Source: "datasource_yandex_vpc_gateway.html.markdown",
				},
			},
		},
		JavaScript: &tfbridge.JavaScriptInfo{
			PackageName: "@pulumiverse/yandex",
		...
		Python: &tfbridge.PythonInfo{
			PackageName: "pulumiverse_yandex",
		...
		Golang: &tfbridge.GolangInfo{
			ImportBasePath: filepath.Join(
				fmt.Sprintf("github.com/freitt/pulumi-%[1]s/sdk/", "yandex"),
