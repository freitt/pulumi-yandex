...
__all__ = ['BillingCloudBindingArgs', 'BillingCloudBinding']

@pulumi.input_type
class BillingCloudBindingArgs:
...
@pulumi.input_type
class _BillingCloudBindingState:
    def __init__(__self__, *,
...
class BillingCloudBinding(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        **Note**: Currently resource deletion do not unbind cloud from billing account. Instead it does no-operations.
        ...
        foo = yandex.BillingCloudBinding("foo",
        ...
        ```sh
         $ pulumi import yandex:index/billingCloudBinding:billingCloudBinding foo cloud-binding-id
        ```
    ...
    def __init__(__self__,
        ...
        **Note**: Currently resource deletion do not unbind cloud from billing account. Instead it does no-operations.
        ...
        :param str resource_name: The name of the resource.
        :param BillingCloudBindingArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(BillingCloudBindingArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = BillingCloudBindingArgs.__new__(BillingCloudBindingArgs)
        ...
        super(BillingCloudBinding, __self__).__init__(
            'yandex:index/billingCloudBinding:billingCloudBinding',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            billing_account_id: Optional[pulumi.Input[str]] = None,
            cloud_id: Optional[pulumi.Input[str]] = None) -> 'BillingCloudBinding':
        """
        ...
        __props__ = _BillingCloudBindingState.__new__(_BillingCloudBindingState)

        __props__.__dict__["billing_account_id"] = billing_account_id
        __props__.__dict__["cloud_id"] = cloud_id
        return BillingCloudBinding(resource_name, opts=opts, __props__=__props__)
