...
__all__ = ['YdbTableTopicArgs', 'YdbTableTopic']

@pulumi.input_type
class YdbTableTopicArgs:
    def __init__(__self__, *,
                 database_endpoint: pulumi.Input[str],
                 consumers: Optional[pulumi.Input[Sequence[pulumi.Input['YdbTableTopicConsumerArgs']]]] = None,
        ...
        """
        The set of arguments for constructing a YdbTableTopic resource.
        :param pulumi.Input[str] database_endpoint: YDB database endpoint. Types: string, required. Default value: "".
        :param pulumi.Input[Sequence[pulumi.Input['YdbTableTopicConsumerArgs']]] consumers: Topic Readers. Types: array[consumer], optional. Default value: null.
    ...
    @property
    @pulumi.getter
    def consumers(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['YdbTableTopicConsumerArgs']]]]:
        """
    ...
    @consumers.setter
    def consumers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['YdbTableTopicConsumerArgs']]]]):
...
class _YdbTableTopicState:
    def __init__(__self__, *,
                 ...
                 supported_codecs: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None):
        """
        Input properties used for looking up and filtering YdbTableTopic resources.
        :param pulumi.Input[Sequence[pulumi.Input['YdbTableTopicConsumerArgs']]] consumers: Topic Readers. Types: array[consumer], optional. Default value: null.
        :param pulumi.Input[str] database_endpoint: YDB database endpoint. Types: string, required. Default value: "".
        :param pulumi.Input[str] name: Topic name. Type: string, required. Default value: "".
        :param pulumi.Input[int] partitions_count: Number of partitions. Types: integer, optional. Default value: 2.
...
class YdbTableTopic(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 consumers: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['YdbTableTopicConsumerArgs']]]]] = None,
                 database_endpoint: Optional[pulumi.Input[str]] = None,
                 description: Optional[pulumi.Input[str]] = None,
                 metering_mode: Optional[pulumi.Input[str]] = None,
                 name: Optional[pulumi.Input[str]] = None,
        ...
        * `starting_message_timestamp_ms` - Timestamp in UNIX timestamp format from which the reader will start reading data. Type: integer, optional. Default value: 0.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['YdbTableTopicConsumerArgs']]]] consumers: Topic Readers. Types: array[consumer], optional. Default value: null.
        :param pulumi.Input[str] database_endpoint: YDB database endpoint. Types: string, required. Default value: "".
        :param pulumi.Input[str] name: Topic name. Type: string, required. Default value: "".
        :param pulumi.Input[int] partitions_count: Number of partitions. Types: integer, optional. Default value: 2.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] supported_codecs: Supported data encodings. Types: array[string]. Default value: ["gzip", "raw", "zstd"].
    ...
    def __init__(__self__,
        ...
        * `starting_message_timestamp_ms` - Timestamp in UNIX timestamp format from which the reader will start reading data. Type: integer, optional. Default value: 0.
        ...
        :param str resource_name: The name of the resource.
        :param YdbTableTopicArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(YdbTableTopicArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = YdbTableTopicArgs.__new__(YdbTableTopicArgs)
        ...
        super(YdbTableTopic, __self__).__init__(
            'yandex:index/ydbTableTopic:ydbTableTopic',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            retention_period_hours: Optional[pulumi.Input[int]] = None,
            retention_storage_mb: Optional[pulumi.Input[int]] = None,
            supported_codecs: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None) -> 'YdbTableTopic':
        """
        Get an existing YdbTableTopic resource's state with the given name, id, and optional extra
        ...
        __props__ = _YdbTableTopicState.__new__(_YdbTableTopicState)
        ...
        __props__.__dict__["retention_storage_mb"] = retention_storage_mb
        __props__.__dict__["supported_codecs"] = supported_codecs
        return YdbTableTopic(resource_name, opts=opts, __props__=__props__)

    @property
    @pulumi.getter
    def consumers(self) -> pulumi.Output[Sequence['outputs.YdbTableTopicConsumer']]:
        """
        Topic Readers. Types: array[consumer], optional. Default value: null.
        """
        return pulumi.get(self, "consumers")
