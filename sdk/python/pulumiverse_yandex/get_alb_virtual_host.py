...
def get_alb_virtual_host(http_router_id: Optional[str] = None,
    ...
    my_vh_data = yandex.get_alb_virtual_host(name=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
        http_router_id=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference))
    ```
